...
from app.utils.loaders import load_css, load_model, load_analytics_base, load_metrics
...
render_hero(analytics_base, metrics)

render_metrics_summary(analytics_base, metrics)
...
render_tab_modelo(st, tab_modelo, model, metrics)
